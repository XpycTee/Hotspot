...
def generate_code(session_id):
    ...
    cache.set(f'sms:attempts:{session_id}', 0, 300)
    cache.set(f'sms:sended:{session_id}', 0, 60)
    return code
...
def set_sended(session_id):
    cache.set(f'sms:sended:{session_id}', 1, 60)
